...
#A股国内开盘时间, 这个时间段,不取历史数据
_DEF_STOCK_OPEN_BEGIN_TIME = "080000" #默认开盘时间为9:30:00
_DEF_STOCK_CLOSE_END_TIME = "153000" #默认收盘时间为15:00:00

#adjust/period 参数
_DEF_STOCK_PERIOD_DAY = "day" #默认数据周期为天
_DEF_STOCK_PERIOD_WEEK = "week" #默认数据周期为周
_DEF_STOCK_PERIOD_MONTH = "month" #默认数据周期为月

_DEF_STOCK_PERIOD_CN = {
    _DEF_STOCK_PERIOD_DAY:"日",
    _DEF_STOCK_PERIOD_WEEK:"周",
    _DEF_STOCK_PERIOD_MONTH:"月",
}

_DEF_STOCK_ADJUST_QFQ = "qfq" #默认调整周期为复权
_DEF_STOCK_ADJUST_HFQ = "hfq" #默认调整周期为后复权

_DEF_STOCK_ADJUST_CN = {
    _DEF_STOCK_ADJUST_QFQ:"前复权",
    _DEF_STOCK_ADJUST_HFQ:"后复权",
}
...
_DEF_STOCK_SIGNAL_MARKET_TREND_CN = {
    _DEF_STOCK_SIGNAL_MARKET_BULLISH:"牛市",
    _DEF_STOCK_SIGNAL_MARKET_BEARISH:"熊市",
    _DEF_STOCK_SIGNAL_BOLL_TREND_UP:"多头趋势",
    _DEF_STOCK_SIGNAL_BOLL_TREND_DOWN:"空头趋势",
    _DEF_STOCK_SIGNAL_BOLL_TREND_RANGE:"震荡行情",
    _DEF_STOCK_SIGNAL_BOLL_TREND_NEUTRAL:"中性",
}
...
_DEF_STOCK_TECHNICAL_INDICATOR_BOLL = "boll" #布林带指标
_DEF_STOCK_TECHNICAL_INDICATOR_ENE = "ene" #能量指标
_DEF_STOCK_TECHNICAL_INDICATOR_DMI = "dmi" #DMI指标
_DEF_STOCK_TECHNICAL_INDICATOR_DMA = "dma" #DMA指标
_DEF_STOCK_TECHNICAL_INDICATOR_SAR = "sar" #SAR指标
_DEF_STOCK_TECHNICAL_INDICATOR_KDJ = "kdj" #KDJ指标
_DEF_STOCK_TECHNICAL_INDICATOR_RSI = "rsi" #RSI指标
_DEF_STOCK_TECHNICAL_INDICATOR_CCI = "cci" #CCI指标
_DEF_STOCK_TECHNICAL_INDICATOR_BIAS = "bias" #Bias指标
_DEF_STOCK_TECHNICAL_INDICATOR_WR = "wr" #WR指标
_DEF_STOCK_TECHNICAL_INDICATOR_VOL = "vol" #成交量指标
_DEF_STOCK_TECHNICAL_INDICATOR_OBV = "obv" #OBV指标
_DEF_STOCK_TECHNICAL_INDICATOR_OTHER = "oth" #其他指标
...
#股票波动率等级
_DEF_STOCK_VOLATILITY_RATING_LOW = "low" #波动率低
_DEF_STOCK_VOLATILITY_RATING_MED = "med" #波动率中
_DEF_STOCK_VOLATILITY_RATING_HIGH = "high" #波动率高
_DEF_STOCK_VOLATILITY_RATING_EXTREME_HIGH = "exth" #波动率极度高
